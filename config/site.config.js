...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'limewolf_admin@limwolf310.onmicrosoft.com',
  ...
  email: 'mailto:limewolf310@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Nicoloas-L0/onedrive-vercel-index',
    },
  ],
